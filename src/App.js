...
const nftpng = "https://ipfs.io/ipfs/Qmd17aGA6nLKvtrMpoW5yb6B9yfR3k2K9YYgZPrc8n8xzM/";

//Contract address
const ADDRESS = "0x0e74ABfb01aC643c6C8F2A9c21928c5DF081c88D";

//API de Etherscan 
const apikey = "E1JZ6G4FKNM1VI4TGUK495SGHE4Y92U75M";
...
<div className='row'>
  ...
  <div class="card" style={{marginTop:"3px ,boxShadow: 1px 1px 10px #000000"}}>
   ...
   {nftdata.map(result => {
     return (
       ...
       <div className="card-body">
							<h5 className="mb-0">JoseNFT NFT Collection #{result.tokenID}</h5>
              <h5 className="mb-0 mt-2">Owner Wallet: <p style={{color:"#5C369B",fontWeight:"bold",textShadow:"1px 1px 2px #000000"}} >{result.to}</p></h5>
                    	<div className="card-bottom d-flex justify-content-between">
							<Button className="btn btn-bordered-white btn-smaller mt-3">
								<i className="mr-2" />Buy Now
							</Button>
              <Button className="btn btn-bordered-white btn-smaller mt-3">
								<i className="mr-2" />Make offer
							</Button>
              </div>  
           </div>
          </div>   
